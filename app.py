...
if 'map_data' not in st.session_state:
    st.session_state.map_data = pd.DataFrame({
        ...
        'Mecha_Armies':, # عدد روبوتات الميكا للكمبيوتر
        'Plasma_Cores': [5, 8, 6, 12, 9, 15]      # إنتاج خلايا البلازما
    })

if 'factions' not in st.session_state:
    st.session_state.factions = {}

# تحويل البيانات إلى متغير محلي لتسهيل التعامل معها
...
# --- عرض الخريطة الرقمية وتقارير الاستخبارات السيبرانية (تم إصلاح الأعمدة هنا) ---
